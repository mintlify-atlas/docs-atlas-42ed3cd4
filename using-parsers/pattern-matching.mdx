...
<CardGroup cols={2}>
  <Card title="Query Syntax" icon="code" href="/using-parsers/queries/syntax">
    Learn the complete query syntax
  </Card>
  
  <Card title="Query Predicates" icon="filter" href="/using-parsers/queries/predicates-and-directives">
